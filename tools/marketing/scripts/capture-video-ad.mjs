 ...
 * headshots into tools/marketing/video-ad/avatars/<member key>.(png|jpg|jpeg|webp);
...
const MARKETING_ROOT = join(SCRIPT_DIR, "..");
const REPO_ROOT = join(MARKETING_ROOT, "..", "..");
const VIDEO_ROOT = join(MARKETING_ROOT, "video-ad");
