...
export function RondoDiscMark({ size }: { size: number }) {
  return (
    ...
    >
      ...
      <line x1="120.25" y1="144.25" x2="139.28" y2="111.28" stroke="#f1f5f9" strokeWidth="10" strokeLinecap="round" />
      <path d="M133.33 107.79 L145.28 100.89 L145.28 114.69" fill="none" stroke="#f1f5f9" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="134.53" y1="84" x2="96.47" y2="84" stroke="#f1f5f9" strokeWidth="10" strokeLinecap="round" />
      <path d="M96.42 90.9 L84.47 84 L96.42 77.1" fill="none" stroke="#f1f5f9" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
      <line x1="75.22" y1="101.75" x2="94.25" y2="134.72" stroke="#f1f5f9" strokeWidth="10" strokeLinecap="round" />
      <path d="M100.25 131.31 L100.25 145.11 L88.3 138.21" fill="none" stroke="#f1f5f9" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
