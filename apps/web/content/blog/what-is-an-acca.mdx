...
No. Plenty of groups play Tiki Acca for points and pride alone — the leaderboard works exactly the same. If your group does bet, you place bets yourselves with licensed UK bookmakers; we never touch money. Set a stake everyone's comfortable with, and if it stops being fun, stop — [GambleAware.org](https://www.gambleaware.org) has free, confidential support. 18+.
