 ...
 * triangle with three white players + thin white passes and a green centre
...
export function LogoMark({ size = 36 }: { size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 220 220" fill="none">
      {/* pass: top → right */}
      <Line x1={121.5} y1={148.08} x2={142.73} y2={111.31} stroke="#f1f5f9" strokeWidth={7} strokeLinecap="round" />
      <Path d="M136.28 107.53 L149.23 100.05 L149.23 115" fill="none" stroke="#f1f5f9" strokeWidth={7} strokeLinecap="round" strokeLinejoin="round" />
      {/* pass: right → left (base) */}
      <Line x1={137.23} y1={81} x2={94.77} y2={81} stroke="#f1f5f9" strokeWidth={7} strokeLinecap="round" />
      <Path d="M94.72 88.47 L81.77 81 L94.72 73.53" fill="none" stroke="#f1f5f9" strokeWidth={7} strokeLinecap="round" strokeLinejoin="round" />
      {/* pass: left → top (build-up) */}
      <Line x1={71.27} y1={100.92} x2={92.5} y2={137.69} stroke="#f1f5f9" strokeWidth={7} strokeLinecap="round" />
      <Path d="M99 134 L99 148.95 L86.05 141.47" fill="none" stroke="#f1f5f9" strokeWidth={7} strokeLinecap="round" strokeLinejoin="round" />
      {/* triangle players */}
