...
| 14 | **Solo accas — finish verification** | Code | Feature shipped (phases 1–3, [spec](./specs/solo-unlimited-legs.md)). Remaining: one manual end-to-end solo run (lock-route guard tests done 2026-09-23). Solo on-ramp UX (dashboard entry point, invite conversion) deliberately deferred to a later spec |
