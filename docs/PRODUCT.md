...
8. Each round has a web/mobile **Banter** thread. Pick submissions, changes, lock, results, and settlement appear as system messages; members can post text and react with the constrained emoji set. Pick rows mirror reactions from their latest announcement.
