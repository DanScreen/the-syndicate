...
export const DEFAULT_ESTIMATED_ODDS_MARGIN = 0.05;
export const DEFAULT_ESTIMATED_ODDS_MIN_REAL_QUOTES = 2;
 ...
 * - are always strictly no better than the best real quote (haircut + floor),
